            ...
            >
                ...
                <div className="flex h-full w-full flex-col items-start justify-center gap-[2.5rem] p-6 lg:px-32 z-20">
                    ...
                    <Link href='/table-booking'>
                        <Button className="dining-button flex items-center font-extrabold font-oswald justify-center gap-3 px-6 py-7 rounded-full bg-primary text-ehite mt-[10px] hover:bg-secondary hover:text-black">Book Now <MoveRight /></Button>
                    </Link>
                </div >
            </div >
        </section >
