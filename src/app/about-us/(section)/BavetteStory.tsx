        ...
        <div className="flex h-full w-full flex-col items-center justify-center gap-4 bg-[#050505] md:flex-row lg:px-24 lg:py-20">
          ...
          <div className="flex h-full w-full flex-col items-center gap-[2.5rem] p-6 md:w-1/2 md:items-start lg:ml-24">
            ...
            <p className="max-w-[450px] text-center font-light leading-[160%] text-[#C1B6A6] md:text-start">
              Located in the lively area of Majester, our restaurant is a gateway to the rich culinary traditions of Bosphorus. Inspired by Turkey’s vibrant flavors and timeless recipes, we bring an authentic dining experience that celebrates the heart of Turkish cuisine. From the bustling spice markets of Bosphorus to the warmth of family kitchens, every dish reflects the passion and heritage of our culture.
              <br />
              <br />
              Our menu is a journey through the iconic tastes of Turkey, offering everything from tender, sizzling kebabs to the sweet indulgence of baklava. Paired with warm Turkish hospitality and a cozy, inviting atmosphere, our restaurant is more than a place to eat—it’s a celebration of Bosphorus’s charm, right here in Majester.
            </p>
          </div>
        </div>
      </div>
